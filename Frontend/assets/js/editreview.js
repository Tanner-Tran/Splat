...
if (localStorage.getItem('editRestName') == null || localStorage.getItem('editReviewTitle') == null || localStorage.getItem('editBodyText') == null || localStorage.getItem('editRating') == null) {
...
function renderReview() {
    document.getElementById('rname').value = toTitleCase(localStorage.getItem('editRestName'));
    document.getElementById('rtitle').value = localStorage.getItem('editReviewTitle');
    document.getElementById('review').value = localStorage.getItem('editBodyText');

    let oldRating = localStorage.getItem('editRating');
...
window.editReview = function editReview() {
